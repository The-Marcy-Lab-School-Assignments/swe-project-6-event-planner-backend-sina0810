...
const { createRsvp, destroy, listByUser } = require('./controllers/rsvpControllers');
const {  listEvent, listUserEvents, createEvents, deleteEvent } = require('./controllers/eventControllers');
...
// rsvp routes 
app.get('/api/users/:user_id/events', checkAuthentication, listByUser);
